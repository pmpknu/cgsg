...
namespace mth
{
  ...
  public:
    ...
    /* Linear interpolation for matrix
     * ARGUMENTS: None.
     *   - matrix to interpolate between:
     *       const matr &Start, const matr &End;
     *   - interpolation coefficient 0 to 1:
     *       const type &t;
     * RETURNS:
     *   (matr) result matrix.
     */
    static matr Lerp( const matr<Type> &Start, const matr<Type> &End, const Type &t )
    {
      return matr(End.M[0][0] * t + Start.M[0][0] * (1 - t), End.M[0][1] * t + Start.M[0][1] * (1 - t), End.M[0][2] * t + Start.M[0][2] * (1 - t), End.M[0][3] * t + Start.M[0][3] * (1 - t),
                  End.M[1][0] * t + Start.M[1][0] * (1 - t), End.M[1][1] * t + Start.M[1][1] * (1 - t), End.M[1][2] * t + Start.M[1][2] * (1 - t), End.M[1][3] * t + Start.M[1][3] * (1 - t),
                  End.M[2][0] * t + Start.M[2][0] * (1 - t), End.M[2][1] * t + Start.M[2][1] * (1 - t), End.M[2][2] * t + Start.M[2][2] * (1 - t), End.M[2][3] * t + Start.M[2][3] * (1 - t),
                  End.M[3][0] * t + Start.M[3][0] * (1 - t), End.M[3][1] * t + Start.M[3][1] * (1 - t), End.M[3][2] * t + Start.M[3][2] * (1 - t), End.M[3][3] * t + Start.M[3][3] * (1 - t));
