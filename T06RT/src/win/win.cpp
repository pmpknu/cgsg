...
gort::win::win( HINSTANCE hInst ) : hInstance( hInst )
{
  WNDCLASS wc;
  HWND hWnd;
  ...
  /* Create window */
  hWnd = CreateWindow(WindowClassName, "T06RT (Ray Tracing)",
...
LRESULT CALLBACK gort::win::WinFunc( HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam )
{
  win *Win;
  HDC hDC;
  PAINTSTRUCT ps;
